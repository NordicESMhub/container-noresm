...
compiler = intel_psxe(eula=True, license='license.lic',  prefix='/usr/local/intel', \
                      tarball='parallel_studio_xe_2020_update4_cluster_edition.tgz', ospackages=['gcc', 'gcc-c++', 'gcc-gfortran', 'make', 'which'], \
...
mpi = openmpi(version='4.1.0', cuda=False, infiniband=True, pmi='/usr/local/slurm-pmi2', 
                      configure_opts=['FFLAGS=-fallow-argument-mismatch', 
